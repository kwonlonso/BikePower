...
public class BikeLocation implements Parcelable {
	...
	public BikeLocation(List<String> LocMan) {
		nman=LocMan.size();
	...
	public static final Parcelable.Creator<BikeLocation> CREATOR
	= new Parcelable.Creator<BikeLocation>() {
		public BikeLocation createFromParcel(Parcel source) {
			return new BikeLocation(source);
			}
	...
	private BikeLocation(Parcel source) {
		nman=source.readInt();
